...
* ultronai.conf: contains configuration settings for ultronaid or ultronai-qt
* ultronaid.pid: stores the process id of ultronaid while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by ultronaid or ultronai-qt
