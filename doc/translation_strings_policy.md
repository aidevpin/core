...
This document provides guidelines for internationalization of the Ultronai Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ultronai_en.ts` remains unchanged.
