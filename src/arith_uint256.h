...
#ifndef ULTRONAI_ARITH_UINT256_H
#define ULTRONAI_ARITH_UINT256_H
...
public:
     ...
     *
     * Ultronai only uses this "compact" format for encoding difficulty
...
#endif // ULTRONAI_ARITH_UINT256_H
