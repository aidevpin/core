...
/** Utility functions used by the Ultronai Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "ultronai:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load ultronai specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a ultronai specific theme is activated (light/dark).*/
