    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  ultronai-qt [command-line options]                     \n";
...
All the Ultronai in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 UTO, 0.01 UTO, 0.1 UTO, 1 UTO and 10 UTO -- sort of like the paper money you use every day.</li> \
