...
// Copyright (c) 2023 The Ultronai developers
...
public:
    CMainParams() {
         ...
         * The characters are rarely used upper AUTOI, not valid as UTF-8, and produce
        ...
        vSeeds.emplace_back("node.ultronai.org");
        vSeeds.emplace_back("node1.ultronai.org");
	vSeeds.emplace_back("node2.ultronai.org");
	vSeeds.emplace_back("node3.ultronai.org");
	vSeeds.emplace_back("node4.ultronai.org");
	vSeeds.emplace_back("node5.ultronai.org");
	vSeeds.emplace_back("node6.ultronai.org");
	vSeeds.emplace_back("node7.ultronai.org");
	vSeeds.emplace_back("node8.ultronai.org");
...
//        	exit(0);
//        }
        std::vector<FounderRewardStructure> rewardStructures = {  {INT_MAX, 10} };// 15% founder/dev fee forever
        consensus.nFounderPayment = FounderPayment(rewardStructures, 1,"1LHvpEHuRh6u9xrey4z2b65UcLUsXCTC5N");
