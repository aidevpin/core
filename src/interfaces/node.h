...
//! Interface for the src/evo part of a ultronai node (ultronaid process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a ultronai node (ultronaid process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a ultronai node (ultronaid process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a ultronai node (ultronaid process).
class Node
{
public:
    virtual ~Node() {}
