Contributing to Ultronai Core
============================

The Ultronai Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/ultronaichain/ultronai/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Ultronai Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Ultronai
Network Protocol consensus changes.

Whether a pull request is merged into Ultronai Core rests with the project merge
...
Patches that change Ultronai consensus rules are considerably more involved than
...
Where a patch set proposes to change the Ultronai consensus, it must have been
...
The review process is normally fairly responsive on the Ultronai Core repository, however
...
The project leader is the release manager for each Ultronai Core release.
