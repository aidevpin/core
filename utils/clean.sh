...
rm -f src/config/ultronai-config.h
...
rm -rf test_bitcoin.coverage/ ultronai-gtest.coverage/ total.coverage/
...
clean_exe src/ultronai-cli
clean_exe src/ultronaid
clean_exe src/ultronai-gtest
clean_exe src/ultronai-tx
clean_exe src/test/test_ultronai
clean_exe src/test/test_ultronai_fuzzy
...
clean_dep . src/config/ultronai-config.h.in
