...
from test_framework.test_framework import UltronaiTestFramework
...
class LLMQChainLocksTest(UltronaiTestFramework):
    def set_test_params(self):
        self.set_ultronai_test_params(6, 5, fast_dip3_enforcement=True)
